    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento',
                 models.DateTimeField(default=datetime.date(2000, 1, 1), verbose_name='Data de Nascimento')),
                ('sobre_voce', models.TextField(default='Sou uma pessoa que...', max_length=500,
                                                verbose_name='Fale mais sobre você')),
                ('objetivos_profissionais',
                 models.TextField(default='Meus objetivos profissionais são ...', max_length=500,
